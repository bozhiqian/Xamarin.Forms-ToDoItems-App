...
namespace TodoAzure
{
    public partial class TodoList : ContentPage
    {
        ...
        private async void OnLogoutButtonClicked(object sender, EventArgs e)
        {
            ...
            if (App.Authenticator != null) loggedOut = await App.Authenticator.LogoutAsync();
            if (loggedOut) Application.Current.MainPage = new LoginPage();
        }
            ...
            if (Device.RuntimePlatform != Device.iOS && todo != null)
                ...
                else
                {
                    ...
                    if (await DisplayAlert("Mark completed?", "Do you wish to complete " + todo.Name + "?", "Complete",
                        "Cancel")) await CompleteItem(todo);
                }
